...
import { NewProductSchema } from './schema/new-product-schema'
...
export function NewProductModule() {
  ...
  async function handleCreateNewProduct(data: NewProductInput) {
    try {
      ...
      router.replace(ROUTES.product.home)
    } catch (err) {
      if (isAxiosError(err)) {
        console.error(err)
      }
              ...
              render={({ field }) => {
                return (
                  <Select value={field.value} onValueChange={field.onChange}>
                    ...
                    <SelectContent>
                      <SelectItem value="blue">calçados</SelectItem>
                      <SelectItem value="green">camisetas e vestuário</SelectItem>
                      <SelectItem value="yellow">uso interno</SelectItem>
                      <SelectItem value="pink">acessórios</SelectItem>
                    </SelectContent>
                  </Select>
                )
              }}
